...
glass". The user logs sips by voice ("bir bardak su içtim") and can ask how
...
PLUGIN = {
    ...
    "description": (
        ...
        "toward a daily goal. Use for: 'su hatırlatıcıyı başlat', 'remind me to "
        "drink water', 'her saat su içmemi hatırlat', 'bir bardak su içtim', 'I "
        "just drank a glass of water', 'log 500 ml of water', 'bugün ne kadar su "
        "içtim', 'how much water have I had today', 'günlük su hedefimi 3 litre "
        "yap', 'stop the water reminders'. This is a repeating hydration "
