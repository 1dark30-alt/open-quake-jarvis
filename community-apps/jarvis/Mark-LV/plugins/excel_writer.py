...
five expenses this week with a total", "create a 12-month sales table and a
chart" — and JARVIS produces a genuine .xlsx on the Desktop:
...
PLUGIN = {
    ...
    "description": (
        ...
        "a total row, and a chart. Use for: 'create an Excel table for me', "
        "'make me a spreadsheet of...', 'turn my weekly expenses into a table "
        "and total them', 'create an xlsx with monthly sales and a bar chart', "
        "'dump this data into Excel'. Pass the user's full request verbatim in "
